...
export const amazonAIExtractor = async (
  ...
  try {
    ...
    await page.waitForSelector(
      "#dp-container, #ppd, [data-feature-name='dp-top-section']",
      { timeout: 15000 }
    );
    ...
    const productData = await extractDataFromScreenshot(screenshot as string);
...
const extractDataFromScreenshot = async (
  ...
  try {
    ...
    const productData: IAmazonProductData = {
