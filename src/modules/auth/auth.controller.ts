...
router.patch("/update-password",auth,validation(updatePasswordSchema),authServices.updatePassword);
...
router.patch("/active-deactive-2fa",auth,validation(activeDeactive2FASchema),authServices.activeDeactive2FA);
